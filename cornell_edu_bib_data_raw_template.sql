...
--
-- Table structure for table `cornell_edu_bib_data_raw`
--

DROP TABLE IF EXISTS `cornell_edu_bib_data_raw`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cornell_edu_bib_data_raw` (
...
--
-- Dumping data for table `cornell_edu_bib_data_raw`
--

LOCK TABLES `cornell_edu_bib_data_raw` WRITE;
/*!40000 ALTER TABLE `cornell_edu_bib_data_raw` DISABLE KEYS */;
/*!40000 ALTER TABLE `cornell_edu_bib_data_raw` ENABLE KEYS */;
UNLOCK TABLES;
